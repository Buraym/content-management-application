<div class="min-w-full h-full data-table-view border-none rounded-lg overflow-x-scroll lg:overflow-hidden">
    <table class="table-auto border-none min-w-full rounded-lg">
        <thead>
            <tr class="bg-gray-100 dark:bg-[#ef2d56] rounded-t-lg border-none">
        ...
        <tbody class="dark:bg-gray-200 rounded-b-lg">
            ...
            @else
                <tr class="border-none rounded-b-lg">
                    <td class="border-none rounded-b-lg border-gray-400 dark:text-[#1e1e24] text-white px-4 py-4 text-center uppercase font-semibold text-xs" colspan="{{ count($columns) + 1 }}">
